...
const statusIcons: Record<string, React.ReactNode> = {
  ...
  RECEIVED: <MessageSquare size={12} className="text-purple-500" />,
      ...
      {waStatus?.state === "connecting" && waStatus.qrcode?.base64 && (
        <div className="mb-6 bg-white rounded-xl border border-amber-200 p-6 flex items-center gap-6">
          ...
          <div>
            ...
            <button
              onClick={fetchWaStatus}
              className="flex items-center gap-2 px-3 py-1.5 bg-purple-700 text-white rounded-lg text-sm hover:bg-purple-800 transition-colors"
            >
              <RefreshCw size={14} />
              Actualizar QR Code
            </button>
