...
const categoryColors: Record<string, string> = {
  ...
  ESTETICA_FACIAL: "bg-purple-50 text-purple-700 border-purple-200",
  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        ...
        <button
          onClick={openNewForm}
          className="flex items-center gap-2 bg-purple-700 text-white px-4 py-2.5 rounded-xl hover:bg-purple-800 transition-colors font-medium text-sm"
        >
          <Plus size={18} />
          Novo Serviço
        </button>
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        ...
        <div className="relative">
          ...
          <select
            ...
            className="pl-10 pr-8 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent appearance-none bg-white"
          >
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="flex items-center gap-3">
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-purple-100 rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-purple-600" />
                </label>
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
                ...
                <button
                  type="submit"
                  className="px-4 py-2.5 text-sm font-medium text-white bg-purple-700 rounded-xl hover:bg-purple-800 transition-colors"
                >
