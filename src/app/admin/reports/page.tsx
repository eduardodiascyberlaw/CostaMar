    ...
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        ...
        <Link
          ...
          className="flex items-center gap-2 text-sm font-medium text-purple-700 bg-purple-50 px-4 py-2.5 rounded-xl hover:bg-purple-100 transition-colors"
        >
          <Percent size={18} />
          Comissões
        </Link>
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="px-3 py-1.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
          />
