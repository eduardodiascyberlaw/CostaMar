...
export default function SettingsPage() {
  ...
  async function fetchWaStatus() {
    ...
    try {
      ...
      setWaStatus({ state: "error", instanceName: "costamar" });
    } finally {
      setWaLoading(false);
    }
  }
    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">
          Configurações gerais do sistema CostaMar
        </p>
      </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                type="text"
                defaultValue="CostaMar by Priscila"
            ...
            <div>
              ...
              <input
                type="text"
                defaultValue="@costamarbypriscila"
                className="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
                disabled
              />
            </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 text-sm text-purple-700 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors w-full justify-center"
            >
              <RefreshCw size={14} />
              Actualizar Estado
            </button>
