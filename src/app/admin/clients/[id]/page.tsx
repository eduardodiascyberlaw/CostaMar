  ...
  if (loading) {
    return (
      <div className="flex justify-center py-20">
        <div className="w-10 h-10 border-3 border-purple-200 border-t-purple-700 rounded-full animate-spin" />
      </div>
    );
  }
    ...
    <div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          {client.appointments.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">Sem atendimentos registados</p>
            </div>
          ) : (
      ...
      {activeTab === "credits" && (
        <div>
          ...
          {/* Credit Form Modal */}
          {showCreditForm && (
            <div className="bg-white border border-purple-200 rounded-xl p-6 mb-4">
              ...
              <form onSubmit={addCredit} className="space-y-4">
                ...
                <div className="flex justify-end gap-3">
                  ...
                  <button type="submit" className="px-4 py-2 text-sm text-white bg-purple-700 rounded-xl hover:bg-purple-800">
                    Registar
                  </button>
                </div>
              </form>
                    ...
                    <div className="mt-3 pt-3 border-t border-gray-100">
                      ...
                      <div className="flex flex-wrap gap-1">
                        {cp.pack.services.map((ps, i) => (
                          <span key={i} className="text-[10px] bg-purple-50 text-purple-700 px-2 py-0.5 rounded-full">
                            {ps.service.name}
                          </span>
                        ))}
                      </div>
