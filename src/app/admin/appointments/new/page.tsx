  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (res.ok) {
        ...
        alert(err.error || "Erro ao criar atendimento");
      }
    } catch {
    ...
    <div>
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-500 mt-1">Registar um novo atendimento</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            <h2 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
              <Scissors size={20} className="text-purple-700" />
              Serviço
            </h2>
            ...
            <select
              ...
              className="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 mb-4"
            >
        ...
        <div className="flex justify-end gap-3 mt-6">
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-2.5 text-sm font-medium text-white bg-purple-700 rounded-xl hover:bg-purple-800 transition-colors disabled:opacity-50"
          >
            <Save size={18} />
            {saving ? "A guardar..." : "Criar Atendimento"}
          </button>
        </div>
      </form>
    </div>
