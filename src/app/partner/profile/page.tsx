    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">
          Os seus dados profissionais na CostaMar
        </p>
      </div>
            ...
            {!editing ? (
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={handleSave}
                  disabled={saving}
                  className="flex items-center gap-1 text-sm text-white bg-purple-700 px-3 py-1 rounded-lg hover:bg-purple-800 disabled:opacity-50"
                >
                  <Save size={14} />
                  {saving ? "..." : "Guardar"}
                </button>
